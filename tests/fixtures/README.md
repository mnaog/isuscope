...
- `slp-windows-v0.2.1.out` is the stdout of the template `slp` collector for that excerpt, run in an `ubuntu:22.04` (amd64, mawk 1.3.4) container with `slp v0.2.1` for Linux amd64, `load_started_at=1789296782.738` and `benchmark_finished_at=1789296845.897`.
